...
export default class MainTask2 extends Phaser.Scene {
    ...
    create() {
        ...
        if (taskType == "planning") {
            ...
            goalProgressBar = this.add.rectangle(decisionPointX+113, 19, Math.round(goalProgress*(barWidth-6)), barHeight-6, 0xFFD700) // initialize at zero
            .setOrigin(0,0) 
            .setScrollFactor(0); 
            progressText = this.add.text(decisionPointX+12, 14, prTxt, {color: "#000000", font: "18px monospace"})
            .setAlign('center')
            .setScrollFactor(0);
