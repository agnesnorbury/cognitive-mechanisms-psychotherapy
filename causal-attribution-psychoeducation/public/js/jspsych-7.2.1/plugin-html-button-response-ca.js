var jsPsychHtmlButtonResponseCA = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          /** Array containing the label text for responses. */
          choices: {
  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          setTimeout(wait_to_click, trial.time_before_choice);
          // store response
          var response = {
              rt: null,
              button: null,
          ...
          function after_response(choice) {
              ...
              display_element.querySelector("#jspsych-html-button-response-stimulus").className +=
                  " responded";
              // display outline around chosen option
              display_element.querySelector(`div[data-choice="${choice}"]`).querySelector(".thought").setAttribute("style","border:2px; border-style:solid; border-color:#000000;")    
              ...
              // enforce wait until end of trial
              if (trial.response_ends_trial) {
                  setTimeout(end_trial, trial.time_after_choice);
              }
