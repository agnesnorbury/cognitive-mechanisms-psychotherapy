...
import { version, infoSheet, briefStudyDescr, debugging, approxTime, hourlyRate, baseEarn, allowDevices } from "./versionInfo.js";
...
const preInstructions = "<div class=\"row\"> "+ 
	...
	"you will earn <b>£"+baseEarn.toFixed(2)+" if you complete the study "+
	"and pass the data quality checks</b> as described on the instructions pages. "+
	"</p>" + 
	"<p>" + 
...
var checkConsent = function () {
	...
	if (consent_checkbox1.checked == true && consent_checkbox2.checked == true && consent_checkbox3.checked == true && consent_checkbox4.checked == true && consent_checkbox5.checked == true && consent_checkbox6.checked == true && consent_checkbox7.checked == true && consent_checkbox8.checked == true && consent_checkbox9.checked == true){
		if (uid) {
			...
			window.scrollTo(0, 0);
			document.getElementById('startStudy').onclick = runStudyNow;
		}
	} else {
...
// once pre-instructions startStudy button clicked, hide consent info and run the study
var runStudyNow = function () {
	if (uid) {
...
// if real exp, display and check consent form before running study- if debugging just run 
if (debugging == false) {
